...
//		this.wait = waitHelper.getWebDriverWaitObject();
	...
	private void waitForPageToLoad(ExpectedCondition pageLoadCondition) {
		wait = new WebDriverWait(driver, Duration.ofSeconds(LOAD_TIMEOUT));
...
//			highlightElement(element);
	...
	public void picture() {
		try {
			...
			ExtentListeners.testReport.get().info(
					"<b>" + "<font color=" + "RED>" + "Screenshot of new Page Navigation" + "</font>" + "</b>",
	...
	public void newPageScreenShot() {
		try {
			ExtentManager.aShot();
			ExtentListeners.testReport.get().info(
					"<b>" + "<font color=" + "Green>" + "Screenshot of new Page Navigation" + "</font>" + "</b>",
					MediaEntityBuilder.createScreenCaptureFromPath(ExtentManager.screenshotName).build());
		
			
//			ExtentListeners.testReport.get().info("<b>" + "<a target=\"_blank\" href='" + ExtentManager.screenshotName
//					+ "'><img src='" + MediaEntityBuilder.createScreenCaptureFromPath(ExtentManager.screenshotName).build() + "height='100 width='100'/></a>" + "</b>");
