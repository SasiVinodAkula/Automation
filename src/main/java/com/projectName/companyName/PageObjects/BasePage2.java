...
public abstract class BasePage2<T> {

	protected WebDriver driver;
	
	public Logger log = Logger.getLogger(BasePage2.class);
...
//		this.wait = waitHelper.getWebDriverWaitObject();
	...
	public T openPage(Class<T> clazz) {
		...
		try {
			...
			ExpectedCondition pageLoadCondition = ((BasePage2) page).getPageLoadCondition();
			waitForPageToLoad(pageLoadCondition);
			((BasePage2) page).getPageScreenSot();
