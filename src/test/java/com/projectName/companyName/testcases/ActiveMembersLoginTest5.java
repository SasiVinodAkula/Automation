...
public class ActiveMembersLoginTest5 extends BaseTest {
	...
	public void loginTest(Hashtable<String,String> data) throws Exception {
		...
		checkOutPage checkoutPage = home.bookItNow(data.get("browser"), data.get("browser"));
		checkoutPage.purchase(data.get("browser"), data.get("browser"));
